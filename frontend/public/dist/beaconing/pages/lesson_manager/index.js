...
var ActiveGLPs = function (_Component) {
    ...
    _createClass(ActiveGLPs, [{
        ...
        value: function () {
            var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
                var loading, glp, loadingEl, glpEl;
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                loading = new _loading2.default();
                                glp = new _glp_box2.default();
                                _context.next = 4;
                            ...
                            case 7:
                                glpEl = _context.sent;
                                return _context.abrupt('return', [glpEl, loadingEl]);
                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                return _context.abrupt('return', Promise.all([header.attach(), mainNav.attach(), secondNav.attach({
                                    ...
                                    return (0, _html.div)('#app', headerEl, (0, _html.div)('.flex-container.expand.margin-top-2', mainNavEl, secondNavEl, (0, _html.main)((0, _html.section)('.flex-column', searchEl), (0, _html.section)('.flex-spacebetween', (0, _html.div)('#active-plans.flex-wrap.flex-grow.margin-20', activeGLPsEl), (0, _html.aside)('.sort', sortEl)))));
                                }));
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                name = data.name;
                                return _context.abrupt('return', (0, _html.p)(name));
            ...
            var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                return _context.abrupt('return', (0, _html.div)('.loading', (0, _html.img)({
            ...
            var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                return _context.abrupt('return', (0, _html.p)('SORT'));
